        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-6">
                ...
                <textarea id="description" name="description" rows="3"
                    class="w-full bg-transparent border-2 border-gray-300 rounded-2xl px-4 py-3 text-lg focus:outline-none focus:border-[#4A0505] transition-colors">{{ old('description') }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="number" id="stock" name="stock" min="0" value="{{ old('stock', 10) }}"
                        class="w-full bg-transparent border-2 border-gray-300 rounded-2xl px-4 py-3 text-lg focus:outline-none focus:border-[#4A0505] transition-colors"
                        required>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <p class="text-xs text-gray-500 mt-2">Flash Sale dan Lunar Day akan ditampilkan di section khusus
                    halaman utama.</p>
            </div>
            ...
            <div id="price-per-day-container" class="mb-6 hidden">
                <label for="price_per_day" class="block text-gray-900 font-black text-xl mb-2">Harga Sewa Per Hari
                    (IDR)</label>
                <input type="number" id="price_per_day" name="price_per_day" min="0" value="{{ old('price_per_day') }}"
                    class="w-full bg-transparent border-2 border-gray-300 rounded-2xl px-4 py-3 text-lg focus:outline-none focus:border-[#4A0505] transition-colors">
            ...
            <div class="mb-6">
                ...
                <div class="flex gap-4">
                    <button type="button" id="btn-yes"
                        class="px-8 py-2 rounded-xl border border-gray-300 font-bold text-gray-700 bg-white hover:bg-gray-50 uppercase shadow-sm w-32">YA</button>
                    <button type="button" id="btn-no"
                        class="px-8 py-2 rounded-xl text-white font-bold bg-[#0000FF] uppercase shadow-sm w-32">TIDAK</button>
                </div>
            ...
            <div class="text-right">
                <button type="submit"
                    class="bg-[#4A0505] hover:bg-[#320303] text-white font-bold py-3 px-8 rounded-xl shadow-md transition-colors text-lg">
                    Simpan Produk
                </button>
            </div>
