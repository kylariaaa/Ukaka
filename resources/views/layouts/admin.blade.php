    ...
    <aside class="w-64 bg-[#4A0505] min-h-screen flex flex-col justify-between py-12 px-6 fixed left-0 top-0">
        ...
        <div class="space-y-16">
            ...
            <nav class="space-y-6 pl-2">
                <a href="{{ route('admin.products.create') }}" class="flex items-center justify-between text-[#E8E8E8] hover:text-white transition-colors group">
                    <span class="text-lg font-medium">add product</span>
                    {{-- Plus Icon --}}
                ...
                <a href="#" class="flex items-center justify-between text-[#E8E8E8] hover:text-white transition-colors group">
                    <span class="text-lg font-medium">List product</span>
                    {{-- List Icon --}}
                    <svg class="w-5 h-5 opacity-80 group-hover:opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="#" class="flex items-center justify-between text-[#E8E8E8] hover:text-white transition-colors group">
                    <span class="text-lg font-medium">Products ordered</span>
                    {{-- Order Receipt Icon --}}
                    <svg class="w-5 h-5 opacity-80 group-hover:opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
